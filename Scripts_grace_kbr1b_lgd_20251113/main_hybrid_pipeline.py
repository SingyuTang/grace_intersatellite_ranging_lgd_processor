...
class LgdProcessor:
    ...
    def __init__(self,
                 ...
                 end_date='2020-06-15',
                 groops_workspace='G:\GROOPS\PNAS2020WorkspaceKBR',
                 instrument='KBR',
                 lon_range=(88, 92),
                 lat_range=(22, 26),
                 lat_limit=(-80.0, 80.0),
        ...
        self.pnas_data_dir = None   # str, PNAS数据目录, 下载链接：https://www.pnas.org/doi/full/10.1073/pnas.2109086118#data-availability 中的LGD数据和Orbit数据
    ...
    def _run_step1(self):
        """执行第一步，计算指定时间段的动力学参考轨道以及提取KBR数据，必须在GROOPS软件中运行"""
        print(f"  正在GROOPS运行脚本: S00GroopsIntegrateOrbitKBR-202007.xml")
        print(f"  正在GROOPS运行脚本: S01SatelliteTrackingFromKBR-202007.xml")
    ...
    def _run_step6(self):
        ...
        print("  注意: PNAS论文不提供KBR数据，因此此步骤无法执行，跳过此步骤")
    ...
    def execute(self, steps_to_run=None):
        ...
        steps_info = {
            1: "计算指定时间段的动力学参考轨道以及提取KBR数据(需要在GROOPS软件中运行)",
            2: "计算指定时间段的LGD和RA",
...
if __name__ == "__main__":
    ...
    # processor.update_config(date_spec=["2020-05"])
    ...
    date_list = [
        '2020-06-03', '2020-06-04', '2020-06-09', '2020-06-10', '2020-06-14',
        '2020-06-15', '2020-06-20', '2020-06-21', '2020-06-25', '2020-06-26',
        '2020-07-01', '2020-07-02', '2020-07-06', '2020-07-07', '2020-07-12',
        '2020-07-13', '2020-07-17', '2020-07-18', '2020-07-23', '2020-07-24',
        '2020-07-28', '2020-07-29', '2020-08-03', '2020-08-04', '2020-08-08',
        '2020-08-09', '2020-08-14', '2020-08-15', '2020-08-19', '2020-08-20',
